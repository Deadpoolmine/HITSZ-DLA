...
`define AUTOTB_TVIN_gmem  "./c.matrixmul.autotvin_gmem.dat"
`define AUTOTB_TVIN_A  "./c.matrixmul.autotvin_A.dat"
`define AUTOTB_TVIN_B  "./c.matrixmul.autotvin_B.dat"
`define AUTOTB_TVIN_out_r  "./c.matrixmul.autotvin_out_r.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.matrixmul.autotvin_gmem.dat"
`define AUTOTB_TVIN_A_out_wrapc  "./rtl.matrixmul.autotvin_A.dat"
`define AUTOTB_TVIN_B_out_wrapc  "./rtl.matrixmul.autotvin_B.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.matrixmul.autotvin_out_r.dat"
`define AUTOTB_TVOUT_gmem  "./c.matrixmul.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.matrixmul.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 137;
parameter LENGTH_gmem = 47;
